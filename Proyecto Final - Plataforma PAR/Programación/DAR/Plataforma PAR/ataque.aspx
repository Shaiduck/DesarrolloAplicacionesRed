<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ataque.aspx.cs" Inherits="Plataforma_PAR.ataque" %>
...
<div id="menu-wrapper">
		<div id="menu">
			<ul>
				...
				<li class="current_page_item"><a href="#">ATAQUE SSH</a></li>
			</ul>
		</div>
</div>
<div id="wrapper">
	<div id="featured-wrapper">
		...
		<div class="extra2 container">
			<div class="ebox1">
				<h1>Ataque SSH</h1>
                <p>Clic en el siguiente botón para iniciar el ataque SSH</p>
                <p>
                    <asp:Button ID="btnAtaque" runat="server" OnClick="btnAtaque_Click" Text="Atacar" />
                </p>
                <p>
                    <asp:Label ID="lblAtaque" runat="server"></asp:Label>
                </p>
			</div>			
		</div>	
	</div>
